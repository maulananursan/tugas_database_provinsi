...
id_provinsi INT, Pulau VARCHAR(50), Provinsi VARCHAR(50),
Singkatan_ISO VARCHAR(2), Ibu_kota VARCHAR(50),
Diresmikan_sebagai_Provinsi DATE, Populasi FLOAT, Luas_Total FLOAT,
Populasi_per_Luas INT, APBD_2014_miliar FLOAT, PDRB_2014_triliun FLOAT,
PDRB_per_kapita_2014_juta FLOAT, IP_2014 FLOAT);
SHOW TABLES;
